...
public class BaronTest {
    ...
    public void test0() throws Throwable {
		...
		assertEquals(state.players.get(0).numBuys, testState.players.get(0).numBuys + newBuys);
        System.out.println(state.players.get(0).scoreFor());
		assertEquals(state.players.get(0).discard.get(0).getCardName(), Card.CardName.Baron);
