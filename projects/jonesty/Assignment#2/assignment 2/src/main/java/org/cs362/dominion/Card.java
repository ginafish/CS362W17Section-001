...
public final class Card implements Comparable<Card>{
	...
	public void play(Player player, GameState state) {
		...
		case Adventurer:
			  ...
			  System.out.println("ADVENTURER PLAYED\n");
		...
		case Ambassador:
			...
			System.out.println("AMBASSADOR PLAYED\n");
		...
		case Councilroom:
			...
			System.out.println("COUNCILROOM PLAYED\n");
	    	 for(int i =0; i<4; i++){ 
		...
		case Cutpurse:
			...
			System.out.println("CUTPURSE PLAYED\n");
		...
		case Village:
	    	  System.out.println("VILLAGE PLAYED" + "\n");
	    	  if(player.deck.size()==0){
	    		  player.shuffleDeck();
	    		  player.drawCard();
	    	  }
