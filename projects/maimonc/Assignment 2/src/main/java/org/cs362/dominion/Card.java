	...
	public final class Card implements Comparable<Card> {
		...
		public void play(Player player, GameState state) {
			...
			case Smithy:
				...
				if(!(cardNum+3 == player.hand.size())){
					if (deckNum >= 3){
						System.out.println("TEST FAILED - SMITHY");
					}
					else 
						System.out.println("TEST PAST - SMITHY");
				}
				else 
					System.out.println("TEST PAST - SMITHY");
			...
			case Salvager:
				...
				if (player.numBuys == numBuy+1){
						System.out.println("TEST PAST - SALVAGER");
					}
				else 
					System.out.println("TEST FAILED - SALVAGER");
			...
			case Village:
				...
				Card temp1;
				cardNum = player.hand.size();
				int numaction = player.numActions;
				...
				if (player.numActions == numaction +2){
					System.out.println("TEST PAST - VILLAGE");
				}
			else 
				System.out.println("TEST FAILED - VILAGE");
				return;
			...
			case Council_room:
				...
				if ((player.numBuys == numbuy +1)){
					System.out.println("TEST PAST - COUNSIL_ROOM");
				}
				else 
				System.out.println("TEST FAILED - COUNSIL_ROOM");				
			...
			case Gardens:
				...
				int numVictory = player.scoreFromPoints;
				...
				if (numberOfCards > 10){
					if (!(numVictory < player.scoreFromPoints)){
						System.out.println("TEST FAILED - GARDENS");
					}
					else 
						System.out.println("TEST PAST - GARDENS");
				}
				else 
					System.out.println("TEST PAST - GARDENS");
			...
			case Great_hall:
				...
				// get 1 estate?
				if (((vp +1 == player.scoreFromPoints )&& (numAction+1 == player.numActions))){
					System.out.println("TEST PAST - GREAT_HALL");
				}
				else {
					System.out.println("TEST FAILED - GREAT_HALL");
				}
			...
			case Mine:
				...
				if (player.hand.size() == numCards){
					System.out.println("TEST PAST - MINE");
				}
				else 
				System.out.println("TEST FAILED - MINE");
