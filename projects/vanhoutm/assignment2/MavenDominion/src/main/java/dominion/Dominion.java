...
*/
    ...
    public int buyCard(int supplyPos, GameState Game) {
      ...
      if (Game.numBuys < 1){
        ...
        //////////////////////////////////
        // INTENTIONAL BUG
        Game.coins = (Game.coins) - (getCost(supplyPos)); // -1 is a bug!         
        //////////////////////////////////
    ...
    public void testBuyCard(GameState Game){
        ...
        for (int i = 0; i < 100; i++){
            ...
            while (stillBuying){
                ...
                int expectedBuys = Game.numBuys -1;
                ...
                assertEquals(expectedBuys, actualBuys,"buy counts don't match: " + expectedBuys + " " + actualBuys);
        ...
        while(isGameOver(Game) == 0){
            for (int p = 0; p < Game.numPlayers; ++p){
                    ...
                    switch (Card.values()[Game.hand[p][handPos]]) {
                        ...
                        case baron:
                            ...
                            if (hasEstate == true){
                                ...
                                choice1 = 0;
                                gainCard(Card.estate.ordinal(),Game,0,p);
                ...
                if (noCard == false){
                    ...
                    if (suppress == false)
                        assertEquals(expectedReturn,actualReturn, "return unexpected " + expectedReturn + " " +actualReturn );
                }
                else
                {
                    expectedActions = 1;
                ...
                if (suppress == false){ 
                    ...
                    assertEquals(expectedActions,Game.numActions, "actions unexpected " + expectedActions + " " + Game.numActions);
                    assertEquals(expectedPlayed,Game.playedCardCount, "played unexpected: " + expectedPlayed + " " + Game.playedCardCount);
                    for (int i = 0; i < Game.numPlayers; ++i){
