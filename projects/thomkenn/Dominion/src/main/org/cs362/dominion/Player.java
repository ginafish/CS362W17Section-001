   ...
   */		   
	   ...
	   public void buyCard() {
		   ...
		   while (numBuys > 0)
		   {
			   ...
			   if (coins >= 4)
			   {
				   if(gameState.gameBoard.get(Card.getCard(gameState.cards, Card.CardName.Baron))!= 0 && gameState.gameBoard.get(Card.getCard(gameState.cards, Card.CardName.Baron))!=null)
				   {
