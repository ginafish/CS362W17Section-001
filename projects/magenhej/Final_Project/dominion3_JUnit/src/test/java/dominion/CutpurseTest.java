...
public class CutpurseTest {
	  ...
	  public void test()  throws Throwable  {	   
		 ...
		 // initialize a game state and player cards
		    ...
		    System.out.println("deck count = " + state.players.get(0).deck.size() + ", expected = "+ (( testState.players.get(0).deck.size()) + 3));
		    ...
		    assertEquals(state.players.get(0).deck.size(),( testState.players.get(0).deck.size() + 3));
